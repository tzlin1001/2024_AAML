            ...
            for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
              ...
              for (int in_channel = 0; in_channel < filter_input_depth;
                ...
                if (filter_input_depth == 1){
                  ...
                  ++in_channel;
                }else{// 結果自己寫的比 tutorial 慢很多 =.=
                  // int32_t shift = group * filter_input_depth;
                  // input_val =
                  //   ((uint8_t)input_data[Offset(input_shape, batch, in_y, in_x,
                  //                     in_channel + shift)] << 24)|
                  //   ((uint8_t)input_data[Offset(input_shape, batch, in_y, in_x,
                  //                     in_channel + shift + 1)] << 16)|
                  //   ((uint8_t)input_data[Offset(input_shape, batch, in_y, in_x,
                  //                     in_channel + shift + 2)] <<  8)|
                  //   ((uint8_t)input_data[Offset(input_shape, batch, in_y, in_x,
                  //                     in_channel + shift + 3)]);
                  // filter_val = 
                  //   ((uint8_t)filter_data[Offset(
                  //     filter_shape, out_channel, filter_y, filter_x, in_channel)] << 24)|
                  //   ((uint8_t)filter_data[Offset(
                  //     filter_shape, out_channel, filter_y, filter_x, in_channel + 1)] << 16)|
                  //   ((uint8_t)filter_data[Offset(
                  //     filter_shape, out_channel, filter_y, filter_x, in_channel + 2)] <<  8)|
                  //   ((uint8_t)filter_data[Offset(
