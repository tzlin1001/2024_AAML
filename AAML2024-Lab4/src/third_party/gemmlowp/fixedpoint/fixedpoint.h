...
//****************************************新加的************************************************//
template <typename tRawType, int tIntegerBits>
FixedPoint<tRawType, 0> cal_exp(FixedPoint<tRawType, tIntegerBits> a){
  int32_t cfu_result = cfu_op0(/* funct7= */ 0, /* in0= */ a, /* in1= */ 0);
  FixedPoint<tRawType, 0> exp_result = FixedPoint<tRawType, 0>::FromRaw(cfu_result);
  return exp_result;
}
template <typename tRawType>
FixedPoint<tRawType, 0> cal_reciprocal(FixedPoint<tRawType, 0> a){
  int32_t cfu_result = cfu_op0(/* funct7= */ 1, /* in0= */ a, /* in1= */ 0);
  FixedPoint<tRawType, 0> reciprocal_result = FixedPoint<tRawType, 0>::FromRaw(cfu_result);
  return reciprocal_result;
}
template <typename tRawType, int tIntegerBits>
FixedPoint<tRawType, 0> cal_exp_for_softmax(FixedPoint<tRawType, tIntegerBits> a){
  int32_t cfu_result = cfu_op0(/* funct7= */ 2, /* in0= */ a, /* in1= */ 0);
  FixedPoint<tRawType, 0> exp_result = FixedPoint<tRawType, 0>::FromRaw(cfu_result);
  return exp_result;
}
//*********************************************************************************************//
...
FixedPoint<tRawType, 0> logistic_on_positive_values(
    FixedPoint<tRawType, tIntegerBits> a) {
  return cal_reciprocal(cal_exp(a));
